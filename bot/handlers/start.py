...
CONSENT_TEXT = """
🎓 <b>Добро пожаловать в СтудМэч!</b>

СтудМэч — платформа для студентов, где ты можешь найти:
• Новых друзей и коллег ❤️
• Партнёров для карьерных проектов 🎯

<b>Перед началом необходимо принять соглашение об обработке персональных данных.</b>

📋 <b>Что мы собираем:</b>
— Имя, фото, данные анкеты
— Корпоративный email (для верификации)
— Загружаемые документы (дипломы, справки)
— Историю взаимодействий внутри платформы

📌 <b>Как используем:</b>
— Для отображения анкеты другим студентам
— Для верификации академических достижений
— Для модерации и безопасности платформы
— Работодатели видят анкеты только после выдачи доступа модератором

🔒 Данные надёжно защищены и не передаются третьим лицам без вашего согласия.

Нажимая <b>«Принимаю»</b>, ты соглашаешься с обработкой персональных данных в соответствии с ФЗ-152.
"""
